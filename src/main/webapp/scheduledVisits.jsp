                    ...
                    <table>
                        ...
                        <c:forEach items="${visits}" var="visit">
                            <tr>
                                ...
                                <c:if test="${visit.paid}">
                                    <td><a class="back" href="/printReceipt/${visit.id}">Generate Receipt</a></td>
                                </c:if>
                                <c:if test="${!visit.paid}">
                                    <td><a class="back" href="/payForVisit/${visit.id}">Pay</a></td>
                                </c:if>
                                <td><a class="back" href="/cancelVisit/${visit.id}">Cancel</a></td>
                            </tr>
                        </c:forEach>
                    </table>
                </c:if>
